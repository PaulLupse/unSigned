    ...
    return (
        <div id="Continut" style={{display:'flex', alignItems:'center', height:'100%', justifyContent:'center'}}>
...

            {
                ...
                <NewQuestionOptions setDisplayQuestionCreator={setDisplayQuestionCreator}
                    addQuestionCallback={
